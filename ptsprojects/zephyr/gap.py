...
def set_pixits(pts):
    ...
    pts.set_pixit("GAP", "TSPX_delete_link_key", "TRUE")
    ...
    pts.set_pixit("GAP", "TSPX_invalid_conn_update_supervision_timeout", "0800")
    ...
    pts.set_pixit("GAP", "TSPX_iut_mandate_mitm", "FALSE")
    ...
    pts.set_pixit("GAP", "TSPX_advertising_data",
                  "0503001801180D095054532D4741502D3036423803190000")
